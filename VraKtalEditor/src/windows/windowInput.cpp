...
WindowInput::WindowInput(core::Input& _input, ImGuiWindows* _imGuiWindow) : m_input(_input) , m_imGuiWindow(_imGuiWindow){}
...
{
	if (m_imGuiWindow->BeginWindow("Input"))
	{
