...
void core::gpu::CommandBuffer::TransitionImageLayout(const core::gpu::Image* image, ImageLayout oldLayout, ImageLayout newLayout, bool isDepth)
{
	...
	else if (oldLayout == ImageLayout::General && newLayout == ImageLayout::TransferSrc)
	{
		srcAccess = vk::AccessFlagBits::eShaderWrite;
		dstAccess = vk::AccessFlagBits::eTransferRead;
		srcStage = vk::PipelineStageFlagBits::eComputeShader;
	...
	else if (oldLayout == ImageLayout::General && newLayout == ImageLayout::TransferDst)
	{
		srcAccess = vk::AccessFlagBits::eShaderWrite;
		dstAccess = vk::AccessFlagBits::eTransferWrite;
		srcStage = vk::PipelineStageFlagBits::eComputeShader;
	...
	else if (oldLayout == ImageLayout::TransferSrc && newLayout == ImageLayout::ShaderReadOnly)
	{
